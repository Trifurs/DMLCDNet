...
> **⚠️ Note:** This `README.md` was generated by Codex and may contain inaccuracies. Please verify all technical details, paths, parameters, and experimental claims against the source code and the original paper before use.
